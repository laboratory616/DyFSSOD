...
data_root = '/root/autodl-tmp/mmdetection/data/visdrone/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'VisDrone2019-DET-train/train_dev.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'VisDrone2019-DET-val/val_dev.json',
